...
namespace BiangStudio.DragHover
{
    public class MouseHoverManager : TSingletonBaseManager<MouseHoverManager>
    {
        ...
        internal HoverPressKeyDelegate HoverKeyDownHandler;
        internal HoverPressKeyDelegate HoverKeyUpHandler;
        ...
        public void Init(HoverPressKeyDelegate hoverKeyDownHandler, HoverPressKeyDelegate hoverKeyUpHandler, GetScreenMousePositionDelegate getMousePositionHandler)
        {
            HoverKeyDownHandler = hoverKeyDownHandler;
            HoverKeyUpHandler = hoverKeyUpHandler;
